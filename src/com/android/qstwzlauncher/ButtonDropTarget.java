...
public class ButtonDropTarget extends TextView implements DropTarget, DragController.DragListener {
    ...
    protected DragController.DeferDragListener mDeferDropTargetBar;
    ...
    public void setSearchDropTargetBar(DragController.DeferDragListener searchDropTargetBar) {
    	mDeferDropTargetBar = searchDropTargetBar;
    }
    ...
    public void onDragEnter(DragObject d) {
        ...
        if(mDeferDropTargetBar != null)
        	mDeferDropTargetBar.notifyDragEnter();
    }
    ...
    public void onDragExit(DragObject d) {
        ...
        if(mDeferDropTargetBar != null)
        	mDeferDropTargetBar.notifyDragExit();
    }
    ...
    public void setIcon(Bitmap paramBitmap)
    {
      ...
      setCompoundDrawablesWithIntrinsicBounds(null, new FastBitmapDrawable(paramBitmap), null, null);
      destroyDrawingCache();
    }
}
