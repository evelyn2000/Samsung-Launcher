 ...
 */
public class SearchDropTargetBar extends FrameLayout implements DragController.DeferDragListener {
	private static final String TAG = "Launcher.SearchDropTargetBar";
    public static final int sTransitionInDuration = 150;
    public static final int sTransitionOutDuration = 125;
