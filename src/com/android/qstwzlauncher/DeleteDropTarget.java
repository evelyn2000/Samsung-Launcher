...
public class DeleteDropTarget extends ButtonDropTarget {
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        ...
        if (isUninstall) {
        	setPadding(res.getDimensionPixelOffset(R.dimen.uninstall_padding_left), getPaddingTop(), getPaddingRight(), getPaddingBottom());
        } else {
        	setPadding(res.getDimensionPixelOffset(R.dimen.remove_padding_left), getPaddingTop(), getPaddingRight(), getPaddingBottom());
        }
