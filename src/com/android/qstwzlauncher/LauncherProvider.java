...
import com.android.qstwzlauncher.LauncherSettings.Favorites;
...
public class LauncherProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "com.android.qstwzlauncher.settings";
    ...
    static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            if (!convertDatabase(db)) {
            	...
            	if(Hotseat.sAllAppsButtonRank == 2)
            		loadFavorites(db, R.xml.default_workspace_middle);
            	else
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            if (version < 9) {
                ...
                if(Hotseat.sAllAppsButtonRank == 2)
            		loadFavorites(db, R.xml.update_workspace_middle);
            	else
