...
public class HolographicOutlineHelper {
    ...
    static {
        ...
        sThickOuterBlurMaskFilter = new BlurMaskFilter(scale * 4.0f, BlurMaskFilter.Blur.OUTER);
        ...
        sThickInnerBlurMaskFilter = new BlurMaskFilter(scale * 3.0f, BlurMaskFilter.Blur.NORMAL);
    ...
    HolographicOutlineHelper() {
        ...
        MaskFilter alphaClipTable = TableMaskFilter.CreateClipTable(20, 35);//TableMaskFilter.CreateClipTable(180, 255);
    ...
    void applyOuterBlur(Bitmap bitmap, Canvas canvas, int color) {
        ...
        mHolographicPaint.setAlpha(200);
