...
public class CellLayout extends ViewGroup {
    ...
    public final static int EXTATTRS_FLAG_LOCK = 1;
    public final static int EXTATTRS_FLAG_FIRST = 2;
    public final static int EXTATTRS_FLAG_LAST = 4;
    protected final int mExtAttrs;
    ...
    private QsChildVisibilityChanged mQsChildVisibilityChanged;
    
    public interface QsChildVisibilityChanged{
    	void onQsChildVisibilityChanged(View child, int visibility);
    }
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mExtAttrs = a.getInt(R.styleable.CellLayout_extAttrs, 0);
        ...
        if(LauncherLog.QS_STYLE_I9300){
	        mNormalBackground = res.getDrawable(R.drawable.homescreen_quick_view_bg);//.homescreen_blue_normal_holo);
	        mActiveGlowBackground = mNormalBackground;//res.getDrawable(R.drawable.homescreen_quick_view_bg);//homescreen_blue_strong_holo);
	        
	        mOverScrollLeft = res.getDrawable(R.drawable.zzzz_scroll_bg_left);
	        mOverScrollRight = res.getDrawable(R.drawable.zzzz_scroll_bg_right);
        ...
        //mActiveGlowBackground.setAlpha(30);
    ...
    public boolean isAttrsLocked(){
    	return (mExtAttrs&EXTATTRS_FLAG_LOCK) > 0;
    }
    
    public boolean isAttrsFirst(){
    	return (mExtAttrs&EXTATTRS_FLAG_FIRST) > 0;
    }
    
    public boolean isAttrsLast(){
    	return (mExtAttrs&EXTATTRS_FLAG_LAST) > 0;
    }
    ...
    public void disableHardwareLayers(){
        mChildren.disableHardwareLayers();
    }
...
//	        	mOverScrollForegroundDrawable.setAlpha(mForegroundAlpha);
    	...
    	if(nDirection == SCROLL_TO_RIGHT){
    		super.setRotationY(0 - percent * 20.0f);
    	} else if(nDirection == SCROLL_TO_LEFT){
    		super.setRotationY(percent * 20.0f);
    	} 
    }
    
    void setOverScrollAmount(float percent, int nDirection) {
...
//        	LauncherLog.w(TAG, "CellLayout::setOverScrollAmount()========nDirection:"+nDirection
//        			+"==percent:"+percent);
//        }
    	//boolean changeRotation = false;
    	if(nDirection != mScrollToDirection){
    		
    		if (nDirection == SCROLL_TO_LEFT && mOverScrollForegroundDrawable != mOverScrollLeft) {
	            mOverScrollForegroundDrawable = mOverScrollLeft;
	        } else if (nDirection == SCROLL_TO_RIGHT && mOverScrollForegroundDrawable != mOverScrollRight) {
	            mOverScrollForegroundDrawable = mOverScrollRight;
	        }
    	...
    	if(nDirection == SCROLL_TO_RIGHT){
    		super.setRotationY(0 - percent * 16.0f);
    	} else if(nDirection == SCROLL_TO_LEFT){
    		super.setRotationY(percent * 16.0f);
    	} 
    ...
    protected void setOverscrollTransformsDirty(boolean dirty) {
        ...
        if(LauncherLog.DEBUG_QS_I9300){
        	LauncherLog.w(TAG, "CellLayout::setOverscrollTransformsDirty()========");
        }
        
        if(false /*LauncherLog.QS_STYLE_I9300 && dirty*/){
    ...
    protected void resetOverscrollTransforms() {
    	if(LauncherLog.DEBUG_QS_I9300){
        	LauncherLog.w(TAG, "CellLayout::resetOverscrollTransforms()========mScrollingTransformsDirty:"+mScrollingTransformsDirty);
        }
        ...
        if (mScrollingTransformsDirty) {
            ...
            if(LauncherLog.QS_STYLE_I9300){
	            ...
	            //setOverScrollAmount(0.0f, SCROLL_TO_NONE);
	            //setPivotX(getMeasuredWidth() / 2);
	            
	            mForegroundAlpha = 0;
	            mScrollToDirection = SCROLL_TO_NONE;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // backgrounds
        if (mShowBackground || mBackgroundAlpha > 0.0f) {
            Drawable bg;
        ...
        if (mCrosshairsVisibility > 0.0f) {
            ...
            final float MAX_ALPHA = LauncherLog.QS_STYLE_I9300 ? 1.0f : 0.4f;
            final int MAX_VISIBLE_DISTANCE = 600;
            final float DISTANCE_MULTIPLIER = 0.012f;
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (mForegroundAlpha > 0 && mOverScrollForegroundDrawable != null) {
        	//android.util.Log.w("QsLog", "CellLayout::dispatchDraw()==================");
    ...
    public void setQsChildVisibilityChanged(QsChildVisibilityChanged lister){
    	mQsChildVisibilityChanged = lister;
    }
	...
	protected void onVisibilityChanged(View changedView, int visibility) {
		...
		if(mQsChildVisibilityChanged != null && visibility == getVisibility())
			mQsChildVisibilityChanged.onQsChildVisibilityChanged(this, getVisibility());
	}
    ...
    public void setFastBackgroundAlpha(float alpha) {
    	//android.util.Log.w("QsLog", "CellLayout::setFastBackgroundAlpha()========"+alpha+"==========");
    	if (LauncherLog.DEBUG_DRAG) {
            //LauncherLog.d(TAG, "setFastBackgroundAlpha: ,mDragging ="+mDragging+", alpha = "
            //        + alpha);
        }
...
//    	android.util.Log.w("QsLog", "CellLayout::setBackgroundAlpha()============"+alpha+"======");
//    	if (LauncherLog.DEBUG_DRAG) {
//            LauncherLog.d(TAG, "setBackgroundAlpha: ,mDragging ="+mDragging+", alpha = "
//                    + alpha);
//        }
        mBackgroundAlpha = alpha;
        invalidate();
    ...
    public boolean animateChildToPosition(final View child, int cellX, int cellY, int duration,
    	...
    	//android.util.Log.w("QsLog", "animateChildToPosition=====");
