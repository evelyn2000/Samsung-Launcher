...
public abstract class PagedView extends ViewGroup implements QsScreenIndicatorLister, ViewGroup.OnHierarchyChangeListener {
    ...
    private static final int PAGE_SNAP_ANIMATION_DURATION = 200;//250;
...
//        if(parent != null){
//	        QsScreenIndicator indicator = (QsScreenIndicator) (parent.findViewById(R.id.paged_view_indicator));
//	        if(indicator != null)
//	        	indicator.initial(getContext(), this);
//        }
    }
...
//        return flag;
    ...
    protected void pageBeginMoving() {
        if (!mIsPageMoving) {
        	if (LauncherLog.DEBUG_QS_I9300) {
                LauncherLog.d(TAG, "pageBeginMoving()=====");
            }
            mIsPageMoving = true;
            onPageBeginMoving();
        }
    ...
    protected void pageEndMoving() {
        if (mIsPageMoving) {
        	if (LauncherLog.DEBUG_QS_I9300) {
                LauncherLog.d(TAG, "pageEndMoving()=====");
            }
            mIsPageMoving = false;
            onPageEndMoving();
        }
...
//        	android.util.Log.d("QsLog", "PagedView::computeScroll(0)====computeScrollOffset==mNextPage:"
//                    +mNextPage
//                    +"==CurrentPage:"+mCurrentPage
//                    +"=mDownMotionX:"+mDownMotionX
//                    +"=startX:"+mScroller.getStartX()
...
//                    +"==TouchState:"+mTouchState);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(com.mediatek.common.featureoption.FeatureOption.Qs_Sub_Project_Name.startsWith("A801")){
        	newWidth = getResources().getDimensionPixelSize(R.dimen.widthspec_size);//(240, 262);
        }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final int childWidthMeasureSpec =
                MeasureSpec.makeMeasureSpec(newWidth - horizontalPadding, childWidthMode);
            final int childHeightMeasureSpec =
                MeasureSpec.makeMeasureSpec(newHeight - verticalPadding, childHeightMode);
        ...
        if (heightMode == MeasureSpec.AT_MOST) {
        	newHeight = maxChildHeight + verticalPadding;
        }
...
//    }
    ...
    public void onChildViewAdded(View parent, View child){
        ...
        if(mQsWorkspaceCallback != null)
        	mQsWorkspaceCallback.onPageCountChanged(getPageCount());
        //android.util.Log.i("QsLog", "onChildViewAdded==PageCount:"+getPageCount()+"==parent:"+((ViewGroup)parent).getChildCount());
		invalidate();
		invalidateCachedOffsets();
    }
    ...
    protected int getScaledMeasuredWidth(View child) {
        ...
        if(LauncherLog.QS_STYLE_I9300){ // dont show left or right screen...
...
//                		break;
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                if (LauncherLog.DEBUG_MOTION || LauncherLog.DEBUG_QS_I9300) {
                    LauncherLog.w(TAG, "onInterceptTouchEvent touch down: finishedScrolling = "
...
//        if (LauncherLog.DEBUG_MOTION || LauncherLog.DEBUG_QS_I9300) {
//            LauncherLog.d(TAG, "determineScrollingStart = " 
        	...
        	if (mTouchState == TOUCH_STATE_SCROLLING) {
                ...
                if(Math.abs(deltaX) >= mMinScrollDeltaX){
                    ...
                    /*if (DEBUG) Log.d(TAG, "onTouchEvent().Scrolling: " + deltaX
                    		...
                    		+"=mDeferScrollUpdate:"+mDeferScrollUpdate);*/
...
//            		break;
        ...
        case MotionEvent.ACTION_UP:
            if (mTouchState == TOUCH_STATE_SCROLLING) {
                ...
                if (((isSignificantMove && deltaX > 0 && !isFling) ||
                    ...
                    //if (DEBUG) {
                        Log.w(TAG, "3 mCurrentPage = " + mCurrentPage + ",mScrollX = " + mScrollX
    ...
    protected void snapToPageWithVelocity(int whichPage, int velocity) {
        ...
        int duration = 0;
        if (LauncherLog.DEBUG) {
            LauncherLog.d(TAG, "snapToPage.getChildOffset(): " + getChildOffset(nDestPage)
                    + ",measured width = " + +getMeasuredWidth() + ", " + getChildWidth(nDestPage)
    ...
    protected void snapToPage(int whichPage, int duration) {
        ...
        if (DEBUG) Log.d(TAG, "snapToPage.getChildOffset(): " + getChildOffset(nDestPage));
        if (DEBUG) Log.d(TAG, "snapToPage.getRelativeChildOffset(): " + getMeasuredWidth() + ", "
                + getChildWidth(nDestPage));
        int newX = isLoopingEnabled() ? (whichPage * getWidth()) : (getChildOffset(nDestPage) - getRelativeChildOffset(nDestPage));
    ...
    protected boolean hasElasticScrollIndicator() {
        return LauncherLog.QS_STYLE_I9300 ? false : true;
    }
