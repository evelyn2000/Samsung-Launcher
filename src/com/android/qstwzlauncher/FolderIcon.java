...
import com.android.qstwzlauncher.FolderInfo.FolderListener;
...
public class FolderIcon extends LinearLayout implements FolderListener {
    ...
    private static final int NUM_ITEMS_IN_PREVIEW = 6; //samsung ui //3
    ...
    private PreviewItemDrawingParams computePreviewItemDrawingParams(int index,
        ...
        int width = FolderIcon.this.getWidth();
        int height = FolderIcon.this.getHeight();
        int row_num = NUM_ITEMS_IN_PREVIEW/2;
        float density = mLauncher.getResources().getDisplayMetrics().density;

        float transY = 15*density + ((int)(index /(row_num))) * height * 0.2f;
        float transX = 2*density + (index%row_num) * width * 0.22f; 

        float totalScale = 0.33f;
