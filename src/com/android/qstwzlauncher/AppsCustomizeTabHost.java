...
import com.android.qstwzlauncher.AppsCustomizePagedView.ContentType;
...
public class AppsCustomizeTabHost extends TabHost implements LauncherTransitionable,
    ...
    private AppsCustomizePagedView mAppsCustomizePaneWidgets;
     ...
     * tabs manually).
     */
    private void setContentTypeImmediate(int type) {
        onTabChangedStart();
    ...
    protected void onFinishInflate() {
        ...
        if(AppsCustomizePagedView.QS_FRAGMENT_APPS_WIDGETS){
        	mAppsCustomizePaneWidgets = (AppsCustomizePagedView)findViewById(R.id.apps_customize_pane_content_widgets);
        }
        ...
        if (LauncherLog.DEBUG_QS_I9300) {
            LauncherLog.i(TAG, "onFinishInflate().=="+this.getVisibility()
            		+"==mTabsContainer:"+mTabsContainer.getVisibility());
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getY() < mAppsCustomizePane.getBottom() 
        		|| (AppsCustomizePagedView.QS_FRAGMENT_APPS_WIDGETS && mAppsCustomizePaneWidgets != null
        			&& event.getY() < mAppsCustomizePaneWidgets.getBottom())) {
            return true;
        }
    ...
    private void onTabChangedStart() {
        ...
        if(AppsCustomizePagedView.QS_FRAGMENT_APPS_WIDGETS && mAppsCustomizePaneWidgets != null){
        	mAppsCustomizePaneWidgets.hideScrollingIndicator(false);
        }
    }
    ...
    private void reloadCurrentPage() {
        if (!LauncherApplication.isScreenLarge()) {
            ...
            if(AppsCustomizePagedView.QS_FRAGMENT_APPS_WIDGETS && mAppsCustomizePaneWidgets != null){
            	mAppsCustomizePaneWidgets.flashScrollingIndicator(true);
            }
        }
        
        if(LauncherLog.DEBUG_QS_I9300) {
            LauncherLog.w(TAG, "reloadCurrentPage ===widget:"
            		+mAppsCustomizePaneWidgets.getVisibility()
            		+"==app:"+mAppsCustomizePane.getVisibility());
        }
        
        if(AppsCustomizePagedView.QS_FRAGMENT_APPS_WIDGETS && mAppsCustomizePaneWidgets != null
        		&& mAppsCustomizePaneWidgets.getVisibility() == View.VISIBLE){
        	mAppsCustomizePaneWidgets.loadAssociatedPages(mAppsCustomizePaneWidgets.getCurrentPage());
        	//mAppsCustomizePaneWidgets.bringToFront();
       		mAppsCustomizePaneWidgets.requestFocus();
       		
       		if(mAppsCustomizePane.getVisibility() == View.VISIBLE){
       			mAppsCustomizePane.setVisibility(View.GONE);
       		}
       		//return;
        }
        ...
        if(mAppsCustomizePane.getVisibility() == View.VISIBLE){
	        ...
	        //mAppsCustomizePane.bringToFront();
    ...
    private void onTabChangedEnd(int type) {
    	if(AppsCustomizePagedView.QS_FRAGMENT_APPS_WIDGETS && mAppsCustomizePaneWidgets != null){
    		if(type == AppsCustomizePagedView.ContentType.Widgets){
    			...
    			mAppsCustomizePaneWidgets.setVisibility(View.VISIBLE);
    			mAppsCustomizePane.setVisibility(View.GONE);
    			mAppsCustomizePaneWidgets.showScrollIndicatorTrack();
    			mAppsCustomizePane.hideScrollIndicatorTrack();
    			
    			
    			mAppsCustomizePaneWidgets.forceSetInstanceStateIndex();

    		} else {
    			
    			mAppsCustomizePane.setVisibility(View.VISIBLE);
    			mAppsCustomizePane.showScrollIndicatorTrack();
    			mAppsCustomizePaneWidgets.hideScrollIndicatorTrack();
    			
    			mAppsCustomizePaneWidgets.setVisibility(View.GONE);
    ...
    public void onTabChanged(String tabId) {
        ...
        if (LauncherLog.DEBUG||LauncherLog.DEBUG_QS_I9300) {
            LauncherLog.w(TAG, "onTabChanged: tabId = " + tabId + ",type = " + type
            ...
            public void run() {
            	...
            	if(AppsCustomizePagedView.QS_FRAGMENT_APPS_WIDGETS && mAppsCustomizePaneWidgets != null){
            		...
            		if ((mAppsCustomizePane.getMeasuredWidth() <= 0 ||
	                        ...
	                        || (mAppsCustomizePaneWidgets.getMeasuredWidth() <= 0 ||
        						mAppsCustomizePaneWidgets.getMeasuredHeight() <= 0)) {
                ...
                AppsCustomizePagedView appCustomizePane = mAppsCustomizePane;
                if(AppsCustomizePagedView.QS_FRAGMENT_APPS_WIDGETS 
                		&& mAppsCustomizePaneWidgets != null
                		&& mAppsCustomizePaneWidgets.getVisibility() == View.VISIBLE){
                	
                		appCustomizePane = mAppsCustomizePaneWidgets;
                ...
                for (int i = visiblePageRange[0]; i <= visiblePageRange[1]; i++) {
                    visiblePages.add(appCustomizePane.getPageAt(i));
                }
                ...
                mAnimationBuffer.scrollTo(appCustomizePane.getScrollX(), 0);
                ...
                for (int i = visiblePages.size() - 1; i >= 0; i--) {
                    ...
                    appCustomizePane.removeView(child);
    ...
    void reset() {
        if (mInTransition) {
            ...
            if(AppsCustomizePagedView.QS_FRAGMENT_APPS_WIDGETS 
            	...
            	mAppsCustomizePaneWidgets.reset();
            }
        }
    }
    ...
    public void onResume() {
        ...
        if (getVisibility() == VISIBLE) {
            ...
            if(AppsCustomizePagedView.QS_FRAGMENT_APPS_WIDGETS 
            	...
            	int currentPage = mAppsCustomizePaneWidgets.getCurrentPage();
	            Log.d(TAG, "AppsCustomizeTabHost.onResume mAppsCustomizePane.mOverScrollX = " + mAppsCustomizePaneWidgets.mOverScrollX +
	            		", mAppsCustomizePane.mScroller.getCurrX() = " + mAppsCustomizePaneWidgets.mScroller.getCurrX());
	            
	            mAppsCustomizePaneWidgets.invalidatePageData(currentPage);
