...
public class LauncherModel extends BroadcastReceiver {
    ...
    LauncherModel(LauncherApplication app, IconCache iconCache) {
        ...
        mMaxScreenCount = res.getInteger(R.integer.config_maxScreenCount);
    ...
    private class LoaderTask implements Runnable {
        ...
        private void loadWorkspace() {
            ...
            final ItemInfo occupied[][][] =
                    new ItemInfo[mMaxScreenCount + 1][mCellCountX + 1][mCellCountY + 1];
//android.util.Log.w("QsLog", "loadWorkspace()===mCellCountX:"+mCellCountX+"==mCellCountY:"+mCellCountY);
            try {
