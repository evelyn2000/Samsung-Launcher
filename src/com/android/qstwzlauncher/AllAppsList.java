...
class AllAppsList {
    ...
    void removeCustomApps() {
    	//String wifiSettingPkgName = "com.android.settings";
    	//String wifiSettingClassName ="com.android.settings.Settings$WifiSettingsActivity";
    	
    	for (ApplicationInfo ai : added) {
    		if (ai.componentName.getPackageName().equals("com.google.android.googlequicksearchbox") &&
    				ai.componentName.getClassName().equals("com.google.android.googlequicksearchbox.SearchActivity")) {
    			 data.remove(ai);
    			 //break;
    		 }else {
				if(com.mediatek.common.featureoption.FeatureOption.Qs_Sub_Project_Name.startsWith("A689")){
					if (ai.componentName.getPackageName().equals("com.androidwasabi.livewallpaper.dandelion") &&
		    				ai.componentName.getClassName().equals("com.androidwasabi.livewallpaper.dandelion.AppLauncher")) {
		    			 data.remove(ai);
		    			 //break;
		    		 }
				}
